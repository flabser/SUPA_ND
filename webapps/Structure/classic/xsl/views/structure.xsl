				...
				<tr>
					<td style="text-align:left">
						<xsl:if test="@hasresponse='true'">
							...
							<img style="margin-left:5px" src="/SharedResources/img/classic/icons/building.png"/><font class="font"  style="font-family:verdana; font-size:12px; margin-left:3px"><xsl:value-of select="@viewtext"/></font>
						</xsl:if>
						<xsl:if test="not(@hasresponse='true')">
							<img style="margin-left:17px" src="/SharedResources/img/classic/icons/building.png"/><font class="font"  style="font-family:verdana; font-size:12px; margin-left:3px"><xsl:value-of select="@viewtext"/></font>
						</xsl:if>
					</td>
				</tr>
