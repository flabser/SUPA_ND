								...
								<div display="block"  id="property">
									...
									<table width="100%" border="0">
										<tr>
			            					...
			            					<td>
				                                <input type="text" name="name" value="{document/fields/name}" size="55" class="td_editable" style="width:300px">
								       	...
								       	<tr>
											...
											<td>
				                                 <input type="text" name="code" id="code" value="{document/fields/code}" size="15" class="td_editable" style="width:300px">
				                                 	<xsl:if test="$editmode != 'edit'">
														<xsl:attribute name="readonly">readonly</xsl:attribute>
														<xsl:attribute name="class">td_noteditable</xsl:attribute>
													</xsl:if>
					       		...
					       		<input type="hidden" name="id" value="DeliveryType"/>		
