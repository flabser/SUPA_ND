                        ...
                        <div class="ui-tabs-panel" id="tabs-1">
                            ...
                            <table width="100%" border="0">
                                <tr>
                                    ...
                                    <td>
                                        <table>
                                            <tr>
                                                <td>
                                                    <input type="text" name="cardnum" maxlength="10"
                                                           class="td_editable" style="width:80px;"
                                                           value="{document/fields/cardnum}"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="carddate" maxlength="10" class="td_editable"
                                               style="width:80px;" value="{document/fields/carddate}"/>
                                    </td>
                                </tr>
                                <!-- Код ЧС -->
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="code" maxlength="10" class="td_editable"
                                               style="width:80px;" value="{document/fields/code}"/>
                                    </td>
                                </tr>
                                <!-- Вид  ЧС -->
                                <tr>
                                    ...
                                    <td>
                                        <select size="1" name="type" style="width:612px;"
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:5px">
                                        <div>
                                            <textarea name="briefcontent" rows="3" tabindex="3"
                                                      style="width:750px" autocomplete="off"
                                                      class="textarea_editable">
                                                <xsl:if test="$editmode !='edit'">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="esdate" maxlength="10" class="td_editable"
                                               style="width:80px;" value="{document/fields/esdate}"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left:5px">
                                        Ориентир :
                                        <input type="text" name="orientirs" class="td_editable"
                                               style="width:160px; margin-left:5px; margin-right:5px"
                                               value="{document/fields/orientirs}"/>
                                        Расстояние :
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="coordinats" class="td_editable"
                                               style="width:200px;" value="{document/fields/coordinats}"/>
                                    </td>
                                </tr>
                                <!-- дороги (значение) -->
                                <tr>
                        ...
                        <div id="tabs-2">
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="carddate" maxlength="10" class="td_editable"
                                               style="width:600px;" value="{document/fields/carddate}"/>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ФИО :
                                        <input type="text" name="carddate" class="td_editable"
                                               style="width:200px; margin-left:5px; margin-right:5px"
                                               value="{document/fields/carddate}"/>
                                        Пол :
                                        <input type="text" name="carddate" maxlength="10" class="td_editable"
