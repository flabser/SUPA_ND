...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="category">
		...
		<xsl:for-each select="entry"> 
			...
			<tr title="{@viewtext}" onmouseover="javascript:elemBackground(this,'EEEEEE')" onmouseout="elemBackground(this,'FFFFFF')" class="{@docid}" id="{concat(@docid,@doctype)}">
	          				...
	          				<xsl:choose>
	          					<xsl:when test=".[responses]">
									<a href="" style="vertical-align:top; margin-left:3px" id="a{@docid}">
										...
										<img border='0' src="/SharedResources/img/classic/1/minus.png" id="{concat('img',@docid)}"/>
									</a>
								</xsl:when>
								<xsl:otherwise>
									<a href="" style="vertical-align:top; margin-left:3px" id="a{@docid}">
										...
										<img border='0' src="/SharedResources/img/classic/1/plus.png" id="{concat('img',@docid)}"/>
									</a>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:if>
