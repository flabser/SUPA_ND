        ...
        <xsl:call-template name="layout">
            <xsl:with-param name="include">
                ...
                <script type="text/javascript">
                    ...
                    if ($.cookie("refresh") != null){ $("[name=refresh]
                    #"+$.cookie("refresh")).attr("selected","selected")}
        ...
        <header class="form-header">
            ...
            <div class="action-bar">
                <button class="btn btn-primary"
                        title="{document/captions/saveandclose/@caption}" id="btnsavedoc">
                        ...
                        <div display="block" id="property" width="100%">
                            ...
                            <table width="80%" border="0" style="margin-top:8px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width:300px;" id="newpwd" name="pwd" type="password"
                                               class="td_editable" autocomplete="off">
                                            <xsl:if test="$editmode != 'edit'">
                                                <xsl:attribute name="class">td_noteditable</xsl:attribute>
                                            </xsl:if>
                                        </input>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width:300px;" id="newpwd2" name="pwd2" type="password"
                                               class="td_editable" autocomplete="off">
                                            <xsl:if test="$editmode != 'edit'">
                                                <xsl:attribute name="class">td_noteditable</xsl:attribute>
                                            </xsl:if>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width:300px" name="instmsgaddress" type="text"
                                               class="td_editable" value="{document/fields/instmsgaddress}">
                                            <xsl:if test="$editmode != 'edit'">
                                                <xsl:attribute name="class">td_noteditable</xsl:attribute>
                                            </xsl:if>
                                        </input>
