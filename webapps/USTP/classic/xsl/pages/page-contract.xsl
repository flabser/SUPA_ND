...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>
					<xsl:value-of select="concat('Надзорная деятельность - Учет сведений о ЧС техногенного и природного характера - ', page/captions/viewnamecaption/@caption)"/>
				</title>
									...
									<div id="tableheader">
										<table class="viewtable" id="viewtable" width="100%" style="">
											<tr class="th">
												...
												<td style="width:120px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
												...
												<td style="width:200px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'VIEWTEXT5'"/>
														<xsl:with-param name="sortorder" select="//query/columns/viewtext5/sorting/@order"/>
														<xsl:with-param name="sortmode" select="//query/columns/viewtext5/sorting/@mode"/>
													</xsl:call-template>
							 					</td>
												<td style="width:200px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
