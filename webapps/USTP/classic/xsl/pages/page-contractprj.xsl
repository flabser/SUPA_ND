											...
											<tr class="th">
												...
												<td style="width:200px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														...
														<xsl:with-param name="sortorder" select="//query/columns/viewtext6/sorting/@order"/>
														<xsl:with-param name="sortmode" select="//query/columns/viewtext6/sorting/@mode"/>
													</xsl:call-template>
												</td>
												<td style="width:200px;" class="thcell">
													<xsl:call-template name="sortingcellpage">
														<xsl:with-param name="namefield" select="'VIEWTEXT7'"/>
