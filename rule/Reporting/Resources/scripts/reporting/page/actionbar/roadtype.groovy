...
class roadtype extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole(["supervisor","administrator","chancellery"])){
			def newDocAction = new _Action(getLocalizedWord("Новый вид дороги", lang),getLocalizedWord("Новый вид дороги",lang),"new_glossary")
			newDocAction.setURL("Provider?type=edit&id=roadtype&key=")
