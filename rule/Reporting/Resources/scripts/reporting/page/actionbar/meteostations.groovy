...
class meteostations extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		if (user.hasRole(["supervisor","administrator","chancellery"])){
			def newDocAction = new _Action(getLocalizedWord("Новая метеостанция", lang),getLocalizedWord("Новая метеостанция",lang),"new_glossary")
			newDocAction.setURL("Provider?type=edit&id=meteostation&key=")
