...
class Geophysical201Actions extends _DoScript {
    ...
    public void doProcess(_Session session, _WebFormData formData, String lang) {
        ...
        if (true || user.hasRole(["administrator"])) {
            ...
            newDocAction.setURL("Provider?type=edit&element=document&id=geophysical-201&docid=")
