...
class QuerySave extends _FormQuerySave {
    ...
    public void doQuerySave(_Session session, _Document doc, _WebFormData webFormData, String lang) {
        ...
        doc.setViewText(_Helper.getDateAsStringShort(doc.getValueDate("taskdate")) + ":" + sh + "  (" + rusExecName + "),  " + doc.getValueString("briefcontent") + ", " + _Helper.getDateAsStringShort(control.getCtrlDate()))
        //0
