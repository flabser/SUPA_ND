...
class DoScript extends _DoScript {
	...
	public void doProcess(_Session session, _WebFormData formData, String lang) {
		...
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии с выбросом (угрозой выброса) РВ",lang), getLocalizedWord("Аварии с выбросом (угрозой выброса) РВ",lang), "emissionrv", "Provider?type=page&id=controltype"))
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии с выбросом (угрозой выброса) БОВ",lang), getLocalizedWord("Аварии с выбросом (угрозой выброса) БОВ",lang), "emissionbov", "Provider?type=page&id=controltype"))
		...
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии на электроэнергетических системах",lang), getLocalizedWord("Аварии на электроэнергетических системах",lang), "electricalaccidents", "Provider?type=page&id=controltype"))
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии на коммунальных системах жизнеобеспечения",lang), getLocalizedWord("Аварии на коммунальных системах жизнеобеспечения",lang), "communalaccidents", "Provider?type=page&id=controltype"))
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии систем связи и телекоммуникаций",lang), getLocalizedWord("Аварии систем связи и телекоммуникаций",lang), "telecomaccidents", "Provider?type=page&id=controltype"))
		tech_outline.addEntry(new _OutlineEntry(getLocalizedWord("Аварии на промышленных очистных сооружениях",lang), getLocalizedWord("Аварии на промышленных очистных сооружениях",lang), "industrialaccidents", "Provider?type=page&id=controltype"))
		...
		nature_outline.addEntry(new _OutlineEntry(getLocalizedWord("Инфекционные заболевания сельскохозяйст-венных животных",lang), getLocalizedWord("Инфекционные заболевания сельскохозяйст-венных животных",lang), "infectionanimal", "Provider?type=page&id=infectionanimal"))
