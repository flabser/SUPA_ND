...
class DoScript extends _DoScript {
	...
	//	println(formData)
        ...
        def formula = "form='order' or form='workdoc' or form='out' or form='L' and recipient='" + session.getCurrentUserID() + "' and vn != '' and has_response = 0";
